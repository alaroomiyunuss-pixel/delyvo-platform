...
(function () {
  ...
  const ar = {
    ...
    'mkt.t.titleArReq': 'اكتب عنوان الإشعار بالعربي', 'mkt.t.sent': 'تم الإرسال إلى {n}', 'mkt.t.bannerOn': 'البانر ظاهر الآن', 'mkt.t.bannerOff': 'تم إخفاء البانر',
  ...
  const en = {
    ...
    'mkt.t.titleArReq': 'Enter the notification title in Arabic', 'mkt.t.sent': 'Sent to {n}', 'mkt.t.bannerOn': 'Banner is now visible', 'mkt.t.bannerOff': 'Banner hidden',
